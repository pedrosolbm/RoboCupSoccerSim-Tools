...
#Instala todas as dependencias necessarias para a configuração e instalação dos componentes do RCSS-TOOLS
	DEPS="automake autoconf libtool g++ flex libboost-all-dev libqt4-dev zlib1g-dev libglib2.0-dev libaudio-dev libxt-dev libpng12-dev libxi-dev libxrender-dev libfontconfig1-dev libclang1-3.6 bison++ ";
	echo "";
